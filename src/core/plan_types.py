...
class VerificationResult:
    ...
    verified_specs: Optional[VerifiedSpecs] = None
    pack_calculation: Optional[PackCalculation] = None
    range_estimate: Optional[RangeEstimate] = None
    issues: List[Issue] = field(default_factory=list)
    confidence: Confidence = field(default_factory=lambda: Confidence(overall=ConfidenceLevel.MEDIUM))
