...
class ConversationSession:
    ...
    current_topic_embedding: Optional[List[float]] = None  # For topic shift detection
    ...
    def add_to_context(self, message: Dict[str, Any], max_tokens: int = 4096, model: str = "gpt-3.5-turbo") -> None:
    ...
    def get_context_messages(self, include_old: bool = False, time_threshold_minutes: int = 30) -> List[Dict[str, str]]:
