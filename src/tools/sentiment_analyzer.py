...
class SentimentAnalyzerTool(BaseTool):
    ...
    def _classify_emotion(self, text: str, scores: Dict[str, float]) -> str:
        ...
        distress_keywords = [
            "worried", "anxious", "stressed", "overwhelmed", "scared",
            "afraid", "concerned", "nervous", "panicking", "help me",
            "don't know what to do", "struggling", "difficult"
        ]
        ...
        frustration_keywords = [
            "frustrated", "annoyed", "angry", "irritated", "upset",
            "disappointed", "why won't", "this doesn't work", "stupid",
            "hate", "terrible", "awful", "ridiculous"
        ]
        ...
        excitement_keywords = [
            ...
            "love", "can't wait", "thrilled", "eager", "brilliant",
            "excellent", "perfect"
        ]
