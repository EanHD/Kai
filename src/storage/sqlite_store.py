...
class SQLiteStore:
    ...
    def _init_schema(self):
        ...
        with self._get_connection() as conn:
            ...
            cursor.execute(
                "CREATE INDEX IF NOT EXISTS idx_tool_query "
                "ON tool_invocations(query_message_id)"
            )
            cursor.execute(
    ...
    # User operations
    def create_user(
        self, user_id: str, encryption_key_hash: str, preferences: Optional[Dict] = None
    ) -> None:
    ...
    def create_conversation(
        self, session_id: str, user_id: str, cost_limit: float = 1.0
    ) -> None:
