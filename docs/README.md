...
Essential documentation for using and understanding Kai.

## Getting Started

- **[Quickstart](../QUICKSTART.md)** - Get running in 5 minutes
- **[Configuration](CONFIGURATION.md)** - Configure models, tools, and settings

## Understanding Kai

- **[Architecture](ARCHITECTURE.md)** - How the system works
- **[Self-Improvement Loop](SELF_IMPROVEMENT_LOOP.md)** - How Kai learns
